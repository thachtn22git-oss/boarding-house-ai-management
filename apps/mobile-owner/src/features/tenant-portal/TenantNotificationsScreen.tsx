...
interface TenantNotificationsScreenProps {
        ...
        <ListCard key={notification.id} title={notification.title}>
          <View style={[styles.notification, !notification.read ? styles.unread : null]}>
            ...
            <View style={styles.actions}>
              ...
              <PrimaryButton label="Delete" onPress={() => void deleteNotification(notification.id)} variant="danger" />
            </View>
          </View>
        </ListCard>
      ))}
...
const styles = StyleSheet.create({
  notification: { gap: spacing.sm },
  unread: { borderLeftColor: colors.success, borderLeftWidth: 3, paddingLeft: spacing.md },
