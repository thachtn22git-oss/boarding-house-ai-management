...
interface TenantMoreScreenProps {
  onNavigate: (tab: TenantTabKey) => void
}

export function TenantMoreScreen({ onNavigate }: TenantMoreScreenProps) {
...
const styles = StyleSheet.create({
  row: { borderBottomColor: colors.border, borderBottomWidth: 1, paddingVertical: spacing.md },
